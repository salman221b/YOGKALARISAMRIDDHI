      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1 space-y-4 text-center sm:text-left">
            <div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 tracking-wide leading-tight">
                YOGKALARISAMRIDDHI
              </h3>
          ...
          <div className="text-center sm:text-left ">
            <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-4 sm:mb-6">Quick Links</h4>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-amber-700 transition-colors text-sm block">
                  Home
                </a>
              </li>
              <li>
          ...
          {/* Support */}
          <div className="text-center sm:text-left">
            <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-4 sm:mb-6">Support</h4>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-amber-700 transition-colors text-sm block">
                  Contact Us
              ...
              <li>
                <p className="text-gray-500 text-sm">Lorem ipsum is a dummy</p>
              </li>
              <li>
                <p className="text-gray-500 text-sm">Lorem ipsum is a dummy</p>
              </li>
          ...
          {/* Legal Info */}
          <div className="text-center sm:text-left">
            <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-4 sm:mb-6">Legal Info</h4>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-amber-700 transition-colors text-sm block">
                  Privacy & Policy
