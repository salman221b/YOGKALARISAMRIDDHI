...
const Hero = () => {
  return (
    <div>
      <h1
        className="float-title text-2xl 2xs:text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 3xl:text-8xl 5xl:text-9xl pt-30 text-center font-semibold text-[#2F5C4E]"
        style={{
      ...
      <p className="sm:text-xl md:text-2xl lg:text-4xl mx-auto text-center text-black mt-7">
        Where Wellness Meets Prosperity
      </p>
      <p className="xs:text-sm sm:text-md md:text-lg lg:text-lg xl:text-xl mx-10 sm:mx-20 md:mx-50 lg:mx-50 xl:mx-70 mt-7 text-center text-black">
